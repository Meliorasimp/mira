      ...
      <div className="pt-10">
        ...
        <div className="h-20 flex justify-center items-center rounded-lg flex-row gap-x-7">
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={html} alt="" className="h-16 w-16" />
          </div>
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={css} alt="" className="h-16 w-16" />
          </div>
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={js} alt="" className="h-16 w-16" />
          </div>
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={react} alt="" className="h-16 w-16" />
          </div>
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={redux} alt="" className="h-16 w-16" />
          </div>
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img
              src={tailwindcss}
          ...
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={typescript} alt="" className="h-16 w-16" />
          </div>
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={java} alt="" className="h-16 w-16" />
          </div>
          <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
            <img src={cs} alt="" className="h-16 w-16" />
          </div>
        </div>
        <div className="pt-5">
          <Heading
          ...
          <div className="h-20 flex justify-center items-center rounded-lg flex-row gap-x-7">
            <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
              <img src={figma} alt="" className="h-16 w-16" />
            </div>
            <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
              <img src={canva} alt="" className="h-16 w-16" />
            </div>
          </div>
        </div>
        <div className="pt-5">
          ...
          <div className="h-20 flex justify-center items-center rounded-lg flex-row gap-x-7">
            ...
            <div className="h-full hover:scale-105 transition-all duration-300 cursor-pointer">
              <img src={vscode} alt="" className="h-16 w-16" />
            </div>
          </div>
        </div>
      </div>
